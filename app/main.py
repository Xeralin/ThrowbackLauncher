...
from core.constants import DATA_ROOT, DEFAULT_DOWNLOADS_DIR, FROZEN, WEB_OUT_DIR, default_library
...
from core.throwbackloader import migrate_legacy_installs
...
FORWARDS = {
    ...
    "update": {"changed": "status", "progress": "progress", "finished": "finished"},
    "uninstall": {"finished": "finished", "item_finished": "item_finished"},
