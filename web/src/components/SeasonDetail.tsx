...
import { SeasonWiki } from "@/components/SeasonWiki";
...
import { SEASON_WIKI } from "@/config/season-wiki";
...
export function SeasonDetail({
  ...
  const wiki = SEASON_WIKI[season.key];
  const tabs: TabItem<TabId>[] = [
    { id: "play", label: "Play" },
    { id: "manage", label: "Manage", disabled: !install.installed },
    ...(wiki ? [{ id: "wiki" as const, label: "Wiki" }] : []),
  ];
