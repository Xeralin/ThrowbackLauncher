...
export function Switch({
  ...
  return (
    ...
    >
      ...
      >
        <span
          className={`absolute top-1/2 -translate-y-1/2 ${s.thumb} ${s.press} shadow-[0_1px_2px_rgba(0,0,0,0.45)] transition-[translate,scale,background-color] duration-200 ease-out ${
            checked
