...
const base =
  "mb-[0.4rem] mr-2 inline-flex items-center gap-2 rounded-md px-[1.1rem] py-[0.55rem] font-mono text-[0.75rem] tracking-[0.08em] no-underline shadow-[0_2px_14px_transparent] transition duration-200";
