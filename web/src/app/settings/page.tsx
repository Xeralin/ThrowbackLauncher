...
import { onBridgeReady, useInfo, useSettings } from "@/lib/bridge";
    ...
    <Row label={label}>
      <div className="flex gap-2">
        <input
          ...
          className={`w-[230px] ${inputClasses} py-[0.4rem] text-body`}
        />
...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    const onDirSaved = () =>
      showToast("success", "Folder saved — restarting the launcher");
    ...
    settings.downloads_dir_saved.connect(onDirSaved);
    ...
    return () => {
      ...
      settings.downloads_dir_saved.disconnect(onDirSaved);
  ...
  return (
    <>
      ...
      {!settings ? (
        ...
        <div className="flex max-w-[1160px] flex-col gap-10">
          <div className="grid grid-cols-2 gap-8 max-[56em]:grid-cols-1">
            <section>
              ...
              <div className="rounded-lg border border-border bg-surface px-5 py-[0.85rem]">
                ...
                <Row label="Downloads folder">
                  <div className="flex gap-2">
                    <Button
                      variant="secondary"
                      onClick={() => settings.change_downloads_dir()}
                    >
                      Change
                    </Button>
                    <Button
                      variant="secondary"
                      onClick={() =>
                        onBridgeReady((bridge) => bridge.info.open_downloads())
                      }
                    >
                      Open
                    </Button>
