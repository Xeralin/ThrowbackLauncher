            ...
            <div className="flex w-fit flex-col gap-4">
              ...
              <div className="rounded-lg border border-border bg-surface px-5 py-4">
                <div className="mb-3 flex items-center justify-between gap-6">
                  ...
                  <span className="flex items-center gap-1.5 font-mono text-label text-text">
                    <span
                      className={`inline-block h-1.5 w-1.5 rounded-full ${radmin.bridgeReady ? "bg-success" : "bg-brand"}`}
                    />
                    {radmin.bridgeReady
                      ? "ready"
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <input
                    ...
                    disabled={busy}
                    className={`min-w-[10rem] flex-1 ${inputClasses} py-[0.4rem] font-mono text-body disabled:opacity-50`}
                  />
                  <Button
                    variant="primary"
