    ...
    a: (
      <>
        <ol>
          ...
          <li>
            <strong>Verify your files</strong> — Use Verify in the Launcher to
    ...
    a: (
      <>
        ...
        <ol>
          ...
          <li>Use Verify in the Launcher to re-download any missing files</li>
        </ol>
        <p className="note">
          If files keep going missing after verifying, double-check that your
          antivirus exclusion is set correctly before running Verify again.
        </p>
        <p>
