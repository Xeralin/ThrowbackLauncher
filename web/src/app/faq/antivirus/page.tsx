    ...
    a: (
      <>
        ...
        <p className="note">
          ...
          then use <strong>Verify</strong> in the Launcher to restore
          any removed files.
        </p>
      </>
    ),
  },
  {
    ...
    a: (
      <ol>
        ...
        <li>
          Use <strong>Verify</strong> in the Launcher to restore any
          missing files
        </li>
      </ol>
    ),
    ...
    a: (
      <>
        <p>
          ...
          You need to add both your R6S folder and the Launcher&apos;s install folder
          as exclusions. The exact steps vary by product, but look for an{" "}
