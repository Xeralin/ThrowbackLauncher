    ...
    a: (
      <>
        ...
        <ol>
          ...
          <li>
            In the Launcher, open <Link href="/settings/rpc">Settings</Link>{" "}
            &gt; <strong>Discord RPC</strong>, enable{" "}
            <strong>Discord presence</strong> and paste the Application ID
          </li>
          <li>
            In the <strong>Details</strong> field, enter a token to show the
            running season — <strong>[season]</strong> gives the full name,{" "}
            <strong>[code]</strong> the code, and <strong>[operation]</strong>{" "}
            the operation. The same tokens work in the <strong>State</strong>{" "}
            line
          </li>
          <li>
            To decorate it further, upload images under{" "}
            <em>Rich Presence &gt; Art Assets</em> and enter their asset names in
