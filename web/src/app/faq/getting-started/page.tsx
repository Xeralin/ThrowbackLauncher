...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    a: (
      <>
        <p>
          Open <strong>Settings → Account</strong> in the Launcher and edit the{" "}
          <strong>Username</strong> field (max 16 characters). The change is
          saved automatically.
        </p>
        <p className="note">
    ...
    a: (
      <>
        ...
        <ol>
          ...
          <li>
            Optional: upload images under <em>Rich Presence → Art Assets</em> in
            your Discord application, then enter their asset names in the{" "}
