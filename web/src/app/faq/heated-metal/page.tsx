...
const heatedMetalSeasons: SeasonRow[] = [
  { season: "Y5S3", operation: "Shadow Legacy (v0.2.3)", build: "15018155" },
  ...
  return (
    <>
      ...
      <Callout label="// NOTE">
        ...
        , not on GitHub, so the Launcher cannot fetch it for you. Get its SDK
        from the Discord and add it to that season yourself.
      </Callout>
      ...
      <Prose>
        <ul>
          ...
          <li>
            ...
            <strong>Console &gt; Network &gt; Connections</strong>, unlocking
            the editor and additional features
          </li>
        </ul>
      </Prose>
    </>
