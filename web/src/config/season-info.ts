...
export type SeasonInfoEntry = {
  ...
  notePlatform?: "windows" | "linux";
};

const HM_ANTIVIRUS_NOTE =
  "Heated Metal is often flagged as a false positive by antivirus software.";
const HM_ANTIVIRUS_LINK = {
  text: "How to fix this",
  href: "/faq/antivirus#why-does-my-antivirus-delete-heated-metal",
};
...
export const SEASON_INFO: Record<string, SeasonInfoEntry> = {
  ...
  Y5S3_ShadowLegacy: {
    ...
    note: HM_ANTIVIRUS_NOTE,
    noteLink: HM_ANTIVIRUS_LINK,
    notePlatform: "windows",
  },
  Y5S4_NeonDawn: {
